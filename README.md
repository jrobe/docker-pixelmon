# [The Pixelmon Modpack 9.1.11](https://www.curseforge.com/minecraft/modpacks/the-pixelmon-modpack) on Curseforge
...
The docker on first run will download the same version as tagged of `The Pixelmon Modpack 9.1.11` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "The Pixelmon Modpack 9.1.11 Server Powered by Docker"
* LEVEL world
